...
export function PowerBiAuthRequired({ returnTo }: { returnTo: string }) {
  return <section className="flex min-h-[560px] items-center justify-center border border-zinc-200 bg-white p-6 text-center">
    <div className="max-w-md">
      ...
      <a href="/workspace/power-bi" className="mt-5 inline-flex h-8 items-center rounded-lg bg-zinc-950 px-3 text-sm font-medium text-white hover:bg-zinc-800">Open Power BI setup</a>
    </div>
  </section>;
}
