...
test("setup guide is the first route and leads into the application", async ({ page }) => {
  ...
  await expect(page.getByRole("heading", { name: "Know what changes before a Power BI report breaks." })).toBeVisible();
